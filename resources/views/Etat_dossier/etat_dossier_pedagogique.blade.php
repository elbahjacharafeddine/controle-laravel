...
<div class="container container-form ml-5" style="margin-left: 300px; margin-top:100px;">
    <legend>Dossiers Pedagogiques</legend>
    <table class="table"  >
    <thead>
        <tr>
        <th scope="col">id</th>
        ...
        <tbody>
            ...
            <td class="text-center">
                <a href="{{ url('validate/dossierPedagogique/'.$item->id) }}">
                    <span class="badge bg-info"><i class="bi bi-check"></i></span>
                </a>
                <a href="#">
                    <span class="badge bg-success"><i class="bi bi-pencil-square"></i></span>
                </a>  
                <a href="{{ url('delete/dossierPedagogique/'.$item->id) }}" onclick="return confirm('Are you sure to want to delete it?')">
